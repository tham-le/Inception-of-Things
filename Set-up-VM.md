# Create a headless Ubuntu Server VM (the "Host VM") that will run Vagrant, Docker, and K3d for your project.

## Prerequisites:
*   VirtualBox installed on your school computer.
*   Ubuntu Server ISO downloaded (e.g., 22.04 LTS or 24.04 LTS).
*   `setup_inception_host.sh` (optional, just to install all needed app)
